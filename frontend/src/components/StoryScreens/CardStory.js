        ...
        <Container className="story-content">
          ...
          <Row className="story-details">
            <Col md="6">
              ...
              <p>
                <strong>Receiver's Name:</strong> {story.content}
              </p>
              <p>
                <strong>Receiver's Address:</strong> {story.address}
              </p>
              <p>
                <strong>Package Name:</strong> {story.packageName}
              </p>
              <p>
            ...
            <Col md="6">
              ...
              <p>
                <strong>Current Status:</strong> {story.status}
              </p>
              <p>
                <strong>Last recorded Location:</strong> {story.location}
              </p>
              <p>
                <strong>Carrier:</strong> {story.carrier}
              </p>
              <p>
          ...
          <Row className="additional-info">
            <Col md="12">
              ...
              <p className="contact-info">
                <strong>Contact Information:</strong> For inquiries, contact our support at albatrossexpress1968@gmail.com. Visit our tracking portal for real-time updates and additional information.
              </p>
            </Col>
          </Row>
        </Container>
